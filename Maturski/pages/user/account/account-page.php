...
<div class="container col-6 col-6-sm">
            ...
            <form id='form' action="handlers/user/update-user.php" method="POST">
                ...
                <div class="form-group text-center">
                    <input type="button" class='btn btn-primary'  name='btnSubmit' value="Update" onclick='submitForm()'>
                </div>
            </form>
        </div>
        <div class="container col-6">
            ...
            <div class="form-group text-center">
                ...
                <div class="form-group text-center">
                    <input type="button" class='btn btn-primary'  name='btnSubmit' value="Change" onclick='changePassword()'>
                </div>
            </form>
        </div>
        <input type='hidden' id='inputId'>
        <div class='text-center'>
        <button class='btn btn-danger'   onclick="onclickDelete(<?php echo $_SESSION['id'];?>)">DEACTIVATE</button>
       <br>
        <button class='btn btn-danger'   onclick="deleteUser(<?php echo $_SESSION['id'];?>)">DELETE</button>
        </div>