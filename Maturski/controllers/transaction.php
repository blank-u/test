            ...
            <form id='form' action="handlers/transaction/update-transaction.php" method="POST">
                ...
                <div class="form-group text-center">
                    ...
                    <select class='form-control col-3 mx-auto' name="subcategory" id="subcategory">
                        <?php //echo "<option value='".$t['subcategory_id']."'>".$subcategory."</option>";
                        ?>
                    </select>
                    <script>
                ...
                <div class="form-group text-center">
                    <input type="button" class='btn btn-primary' id="btnSubmit" name='btnSubmit' value="Update" onclick='submitForm()'>
                </div>
            </form>
        </div>
    <?php }
    ...
    ?>
        <div class="container col-6 col-6-sm">
            ...
            <form id='form' action="handlers/transaction/new-transaction.php" method="POST">
                ...
                <div class="form-group text-center">
                    <p class='text-center'>Target<b class="text-danger">*</b></p>
                ...
                <div class="form-group text-center">
                    <input type="button" class='btn btn-primary' id="btnSubmit" name='btnSubmit' value="Create" onclick='submitForm()'>
                </div>
            </form>
        </div>
<?php
