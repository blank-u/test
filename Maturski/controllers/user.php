            ...
            <form id='form' action="handlers/user/update-user.php" method="POST">
                ...
                ?>
                    <div class="form-group text-center">
                        <p class="text-center">Id<b class="text-danger">*</b></p>
                        <input type="number" value="<?php echo $user['id']; ?>" placeholder="Id" class='form-control col-3 mx-auto' name="id" id="id" required>
                    </div>
                <?php
                }
                ?>
